...
<head>
	...
	<link rel="stylesheet" href="<?php echo CSSPATH;?>backend.css?v=<?php echo time();?>">
...
<nav class="navbar navbar-inverse navbar-fixed-top">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
       ...
       <li><a href="<?php echo __ROOT__;?>Index/add">发布笑话</a></li>
	...
	<div class="container-fluid margin100 minheight">		
		...
		<div class="panel panel-default">
		  <div class="panel-heading"><?php echo $v['nickname'];?>发表于<?php echo date('Y-m-d H:i:s',$v['ctime']);?></div>
